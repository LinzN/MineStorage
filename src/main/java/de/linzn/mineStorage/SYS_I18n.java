...
public class SYS_I18n {

    private static SYS_I18n INSTANCE;
    ...
    public SYS_I18n(Plugin plugin, String locale) {
        INSTANCE = this;
        ...
        defaultLocaleFile = new File(localeFolder, "locale_deDE.yml");
        customLocaleFile = new File(localeFolder, "locale_" + locale + ".yml");

        if (!defaultLocaleFile.exists()) {
            loadLocaleFile(plugin, "locale_deDE", defaultLocaleFile);
        }
